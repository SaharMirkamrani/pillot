        ...
        <div className="text-center flex flex-col justify-center m-auto my-10">
          ...
          <div className="mt-5 flex flex-col justify-center w-1/2 md:w-1/3 lg:w-1/4 mx-auto">
            ...
            <p className="text-right my-2 mr-3 text-gray-600 text-sm">
              {' '}
              عکس هایی از فضای داخل و بیرون ملک اضافه کنید. آگهی های دارای عکس
              تا 3 برابر بیشتر توسط کاربران دیده میشوند.
            </p>
          ...
          <div className="mt-5 flex flex-col justify-center w-1/2 md:w-1/3 lg:w-1/4 mx-auto">
            ...
            <p className="text-right my-2 mr-3 text-gray-600 text-sm">
              {' '}
              در توضیحات آگهی به مواردی مانند شرایط اجاره, جزییات و ویژگی های
              قابل توجه, دسترسی های محلی و موقعیت قرارگیری ملک اشاره کنید.
            </p>
            <textarea
